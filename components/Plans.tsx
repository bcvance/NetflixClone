            ...
            <div className="mt-4 flex flex-col space-y-4">
                <div className="flex w-full items-center justify-end self-end md:w-3/5">
                    {products.map((product) => (
                        <div className={`plan-box ${selectedPlan?.id === product.id ? "opacity-100" : "opacity-60"}`} key={product.id}
                ...
                <button
                    ...
                    className={`bg-[#E50914] w-[40%] pt-5 pb-5 mx-auto rounded text-xl shadow hover:bg-[#f6121d] md:w-[420px] 
